...
ns.iconData = {
  ...
  ["PRIEST"] = {
    ...
    -- Surge of Dominance
    {spells = {92218, 85027}, size = 23, alpha = 1, unit = "player", isMine = false, setPoint = {"BOTTOMRIGHT", UIParent, "CENTER", -96, -25}},

    -- Power Torrent
    {spells = {74241}, size = 23, alpha = 1, unit = "player", isMine = false, setPoint = {"BOTTOMRIGHT", UIParent, "CENTER", -121, -25}},
  },
  ["ROGUE"] = {
